...
import (
	tokenfactorymodule "fandomChain/x/tokenfactory/module"
	tokenfactorymoduletypes "fandomChain/x/tokenfactory/types"
...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions) error {
	...
	tokenfactoryIBCModule := tokenfactorymodule.NewIBCModule(app.appCodec, app.TokenfactoryKeeper)
	ibcRouter.AddRoute(tokenfactorymoduletypes.ModuleName, tokenfactoryIBCModule)
