...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryEvidence: (hash: string, query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryEvidenceRequest>>>, "hash">, params?: RequestParams) => Promise<AxiosResponse<{
        evidence?: {
            type_url: string;
            value: string;
        };
     ...
     */
    queryAllEvidence: (query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllEvidenceRequest>>>, "">, params?: RequestParams) => Promise<AxiosResponse<{
        evidence: {
            type_url: string;
            value: string;
        }[];
