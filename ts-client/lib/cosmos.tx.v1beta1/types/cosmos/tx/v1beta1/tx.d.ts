...
export declare const TxRaw: MessageFns<TxRaw>;
export declare const SignDoc: MessageFns<SignDoc>;
export declare const SignDocDirectAux: MessageFns<SignDocDirectAux>;
export declare const TxBody: MessageFns<TxBody>;
export declare const AuthInfo: MessageFns<AuthInfo>;
export declare const SignerInfo: MessageFns<SignerInfo>;
export declare const ModeInfo: MessageFns<ModeInfo>;
export declare const ModeInfo_Single: MessageFns<ModeInfo_Single>;
export declare const ModeInfo_Multi: MessageFns<ModeInfo_Multi>;
export declare const Fee: MessageFns<Fee>;
export declare const Tip: MessageFns<Tip>;
export declare const AuxSignerData: MessageFns<AuxSignerData>;
