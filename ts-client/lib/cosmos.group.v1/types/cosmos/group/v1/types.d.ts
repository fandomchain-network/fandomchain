...
export declare const MemberRequest: MessageFns<MemberRequest>;
export declare const ThresholdDecisionPolicy: MessageFns<ThresholdDecisionPolicy>;
export declare const PercentageDecisionPolicy: MessageFns<PercentageDecisionPolicy>;
export declare const DecisionPolicyWindows: MessageFns<DecisionPolicyWindows>;
export declare const GroupInfo: MessageFns<GroupInfo>;
export declare const GroupMember: MessageFns<GroupMember>;
export declare const GroupPolicyInfo: MessageFns<GroupPolicyInfo>;
