...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/cosmos/epochs/v1beta1/epochs
     */
    queryEpochInfos: (query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        epochs: {
            identifier: string;
            start_time?: string;
            duration?: {
     ...
     * @request GET:/cosmos/epochs/v1beta1/current_epoch
     */
    queryCurrentEpoch: (query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryCurrentEpochRequest>>>, "">, params?: RequestParams) => Promise<AxiosResponse<{
        current_epoch: any;
    }, any>>;
}
export {};
