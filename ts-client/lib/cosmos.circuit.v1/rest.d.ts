...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    queryAccount: (address: string, query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        permission?: {
            level: import("./types/cosmos/circuit/v1/types").Permissions_Level;
     ...
     */
    queryDisabledList: (query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
