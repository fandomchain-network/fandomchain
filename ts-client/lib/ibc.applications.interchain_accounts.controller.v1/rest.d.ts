...
/**
 * @title ibc.applications.interchain_accounts.controller.v1
 */
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryInterchainAccount: (owner: string, connection_id: string, query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        address: string;
    }, any>>;
    /**
     * QueryParams
