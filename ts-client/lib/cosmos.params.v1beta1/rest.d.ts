...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryParams: (query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsRequest>>>, "">, params?: RequestParams) => Promise<AxiosResponse<{
        param?: {
            subspace: string;
            key: string;
            value: string;
     ...
     */
    querySubspaces: (query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        subspaces: {
            subspace: string;
            keys: string[];
        }[];
