...
/**
 * @title cosmos.base.node.v1beta1
 */
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    serviceConfig: (query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
     ...
     */
    serviceStatus: (query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        earliest_store_height: any;
        height: any;
        timestamp?: string;
        app_hash: string;
