...
/**
 * @title ibc.core.client.v2
 */
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    /**
     * QueryCounterpartyInfo
     *
     * @tags Query
     * @name queryCounterpartyInfo
     * @request GET:/ibc/core/client/v2/counterparty_info/{client_id}
     */
    queryCounterpartyInfo: (client_id: string, query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        counterparty_info?: {
     ...
     * @tags Query
     * @name queryConfig
     * @request GET:/ibc/core/client/v2/config/{client_id}
     */
    queryConfig: (client_id: string, query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        config?: {
