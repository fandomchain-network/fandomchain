...
export const BlogPacketData: MessageFns<BlogPacketData> = {
  encode(message: BlogPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlogPacketData {
  ...
  create<I extends Exact<DeepPartial<BlogPacketData>, I>>(base?: I): BlogPacketData {
    return BlogPacketData.fromPartial(base ?? ({} as any));
  },
