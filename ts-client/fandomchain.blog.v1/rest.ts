...
import { QueryParamsResponse } from "./types/fandomchain/blog/v1/query";

import { QueryParamsRequest } from "./types/fandomchain/blog/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/fandomChain/blog/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/fandomChain/blog/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
